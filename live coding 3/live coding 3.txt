...
retroalimentacion: tiene la idea de como se tiene que estructurar el programa pero falla al momento de implementarla en el codigo, recmiendo practica y leer mas documentacion. 
...
import java.util.*;
	...
	public static void main(String[] args) {
		...
		//System.out.print("ingresa cantidad de mangos");
		int cajaMangos =  127;
		int cajaNAranjas = 456789;
		
		
		//caja 100
		
		System.out.println("tienes" + cajaMangos + "cajas de mangos y " + )
